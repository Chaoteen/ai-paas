...
from sqlalchemy import String, Boolean, ForeignKey, Integer, BigInteger, Numeric, Index, UniqueConstraint
...
class Quota(Base):
    ...
    __table_args__ = (
        UniqueConstraint('organization_id', 'project_id', 'metric', 'period_start', name='uq_quota'),
